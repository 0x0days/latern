/**
 * The Google Colab ingestion script, kept as a raw string so the
 * in-app Data Pipeline tab can display, copy and download it.
 */
export const COLAB_SCRIPT = String.raw`# ============================================================

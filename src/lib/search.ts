...
const SYNONYMS: Record<string, string[]> = {
  ...
  quran: ["quran", "recitation", "mushaf", "preserved"],
  prophethood: ["prophethood", "prophet", "prophets", "muhammad", "messengership"],
  truth: ["truth", "true", "haqq", "haq"],
  atheist: ["atheist", "atheists", "atheism", "god", "creator", "existence", "design"],
  liberal: ["liberal", "liberals", "liberalism", "modern"],
  women: ["women", "woman", "rights", "sisters", "hijab", "modesty"],
  hijab: ["hijab", "headscarf", "veil", "modesty", "khimar"],
  moses: ["moses", "musa"],
  musa: ["musa", "moses"],
  jesus: ["jesus", "isa", "christ", "messiah"],
  isa: ["isa", "jesus"],
  gospel: ["gospel", "gospels", "injeel", "bible"],
  bible: ["bible", "scripture", "scriptures", "gospels", "testament"],
  god: ["god", "allah", "creator", "lord", "deity"],
  allah: ["allah", "god", "creator"],
  suffering: ["suffering", "evil", "hardship", "trials", "test", "pain"],
  evil: ["evil", "suffering", "problem"],
  evolution: ["evolution", "evolve", "darwin", "naturalism", "science"],
  crucifixion: ["crucifixion", "crucified", "cross"],
  trinity: ["trinity", "trinitarian", "tritheism"],
  miracle: ["miracle", "miracles", "signs", "prophecies"],
  hadith: ["hadith", "sunnah", "narrations", "authenticity"],
  aisha: ["aisha", "aishah", "marriage", "marriages"],
  apostate: ["apostate", "apostasy", "leaving", "ex-muslim"],
  heaven: ["heaven", "jannah", "paradise"],
  hell: ["hell", "jahannam", "fire"],
